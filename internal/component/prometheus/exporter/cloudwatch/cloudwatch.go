...
func createExporter(opts component.Options, args component.Arguments) (integrations.Integration, string, error) {
	...
	if a.DecoupledScrape.Enabled {
		exp, err := cloudwatch_exporter.NewDecoupledCloudwatchExporter(opts.ID, opts.Logger, exporterConfig, a.DecoupledScrape.ScrapeInterval, fipsEnabled, a.LabelsToSnakeCase, a.Debug, a.UseAWSSDKVersion2)
		return exp, getHash(a), err
	}

	exp, err := cloudwatch_exporter.NewCloudwatchExporter(opts.ID, opts.Logger, exporterConfig, fipsEnabled, a.LabelsToSnakeCase, a.Debug, a.UseAWSSDKVersion2)
	return exp, getHash(a), err
}
